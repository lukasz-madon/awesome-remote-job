...
Don't use any vague marketing language. Optimize word greppability. For example, if one wants to find python jobs, or to filter for US-only job boards, the following descriptions would be useful:
